...
```{r, echo=FALSE}
load("output/iris.Rdata")
df <- as.data.frame(iris[1:6,])
knitr::kable(df, digits = 3)
# kableExtra::kable(df, digits = 3, booktabs = T, linesep = "") # useful for pdf
```

Notes: Chi-square is a measure of the community variance explained by each environmental variable (also shown as the fraction of total, Frac. Expl.). Explanatory variables OC type and Month are factors and others are continuous. \*All variables showed significant effects at the p ≤ 0.001 level.
